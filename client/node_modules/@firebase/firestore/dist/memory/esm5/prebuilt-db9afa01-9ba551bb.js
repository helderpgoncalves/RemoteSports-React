 ...
 */ function E(t) {
    ...
    if (b.logLevel <= e.DEBUG) {
        var i = n.map(N);
        b.debug.apply(b, m([ "Firestore (8.2.2): " + t ], i));
    }
}
...
function I(t) {
    ...
    if (b.logLevel <= e.ERROR) {
        var i = n.map(N);
        b.error.apply(b, m([ "Firestore (8.2.2): " + t ], i));
    }
}
...
function T(t) {
    ...
    if (b.logLevel <= e.WARN) {
        var i = n.map(N);
        b.warn.apply(b, m([ "Firestore (8.2.2): " + t ], i));
    }
}
 ...
 */ var Ot = /** @class */ function() {
    ...
    /** Returns an ObjectValue with all mutations applied. */ t.prototype.yt = function() {
        ...
        return null != t ? new Ot(t) : this.At;
    }, 
    /**
 ...
 */ function ce(t) {
    ...
    if (null === e.Ot) {
        ...
        n.ht() || e.Ot.push(new Zt(n)), e.Ot.push(new Zt(et.lt(), "asc" /* ASCENDING */)); else {
 ...
 */ function fe(t) {
    var e = D(t);
    if (!e.Ft) if ("F" /* First */ === e.limitType) e.Ft = xt(e.path, e.collectionGroup, ce(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        ...
        // Now return as a LimitType.First query.
                e.Ft = xt(e.path, e.collectionGroup, n, e.filters, e.limit, s, a);
    }
    return e.Ft;
}
 ...
 */ function Ie(t, e, n) {
    ...
    }(n, e) : t instanceof Se ? De(t, e) : t instanceof Oe ? ke(t, e) : function(t, e) {
 ...
 */ function Te(t, e, n) {
    ...
    // applications.
    return t instanceof Se ? De(t, e) : t instanceof Oe ? ke(t, e) : n;
}
...
/** Transforms an array value via a remove operation. */ var Oe = /** @class */ function(t) {
    function e(e) {
        var n = this;
        return (n = t.call(this) || this).elements = e, n;
    }
 ...
 */ function je(t, e) {
    return function(t, e) {
        for (var n = null, r = 0, i = t; r < i.length; r++) {
            ...
            null != s && (n = null == n ? (new kt).set(o.field, s) : n.set(o.field, s));
        }
        return n ? n.yt() : null;
    }(t.fieldTransforms, e);
}
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && L(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof Se && e instanceof Se || t instanceof Oe && e instanceof Oe ? L(t.elements, e.elements, gt) : t instanceof Ce && e instanceof Ce ? gt(t.Qt, e.Qt) : t instanceof Ae && e instanceof Ae;
...
function Ke(t, e, n) {
    ...
    }(t, r = e instanceof Vt ? e.data() : Ot.empty()), r = Qe(t.fieldTransforms, r, n);
}
...
function Qe(t, e, n) {
    for (var r = new kt(e), i = 0; i < t.length; i++) {
        var o = t[i];
        r.set(o.field, n[i]);
    }
    return r.yt();
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    return t.prototype.wn = function(t) {
        for (var e = 0, n = t.je; e < n.length; e++) {
            var r = n[e];
            t.We instanceof Vt ? this.En(r, t.We) : t.We instanceof Rt && this.Tn(r, t.key, t.We);
        }
    ...
    t.prototype.pn = function(t) {
        ...
        return this._n = fn(), this.fn = kn(), this.dn = new sn(C), i;
    }, 
    /**
 ...
 */ var ar = function() {
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.On && A(), this.On = !0, this.Nn ? this.error ? this.Fn(n, this.error) : this.kn(e, this.result) : new t((function(t, i) {
            r.Cn = function(n) {
                r.kn(e, n).next(t, i);
            }, r.xn = function(e) {
                r.Fn(n, e).next(t, i);
 ...
 */
    ...
    t, e, n, r) {
        ...
        /**
             ...
             */
        this.Ec = X.min(), this.Ho = t.Ko(n), this.Tc = t.Fr(), this.fo = t.Dr(), this.Ic = new Nr(this.Tc, this.Ho, this.persistence.jo()), 
              ...
              case 0:
                return n = D(t), r = n.Ho, i = n.Ic, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    return n.Ho.bi(t).next((function(u) {
                        ...
                        // MutationQueue.
                        i = new Nr(n.Tc, r, n.persistence.jo()), r.bi(t);
                    })).next((function(e) {
 ...
 */ function xr(t, e, n) {
    ...
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            ...
            return r.fc.jr(t, e, n ? i : X.min(), n ? o : gn());
        })).next((function(t) {
            return {
                documents: t,
                Pc: o
 ...
 */ var Fr = /** @class */ function() {
    ...
    return t.prototype.Ri = function(t) {
        ...
        var n = this;
        S(0 === this.jc(e.batchId, "removed")), this.Ho.shift();
        var r = this.qc;
 ...
 */ var oi = /** @class */ function() {
    ...
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.Wu = 0, this.Gu = null, this.stream = null, this.zu = new oi(t, e)
        /**
                        ...
                        [ 4 /*yield*/ , function(t) {
                            return y(this, void 0, void 0, (function() {
                                ...
                                return g(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = D(t)).Oh.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , pi(e) ];
        ...
        return g(this, (function(i) {
            switch (i.label) {
              case 0:
                ...
                return t.Oh.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , pi(t) ];
                    ...
                    return y(r, void 0, void 0, (function() {
                        return g(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.Oh.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , li(t) ];
 ...
 */ function Ri(t, e) {
    return y(this, void 0, void 0, (function() {
        ...
        return g(this, (function(i) {
            switch (i.label) {
              case 0:
                return n = D(t), e ? (n.Oh.delete(2 /* IsSecondary */), [ 4 /*yield*/ , li(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return i.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return (r = e) ? [ 3 /*break*/ , 4 ] : (n.Oh.add(2 /* IsSecondary */), [ 4 /*yield*/ , pi(n) ]);
        ...
        return g(this, (function(c) {
            switch (c.label) {
              ...
              case 4:
                ...
                e.zh(n.onlineState), o.jh && e.Hh(o.jh) && Gi(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ var Hi = /** @class */ function() {
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.zh = function(t) {
        ...
        t = En.Oe(t.query, t.docs, t.Ce, t.fromCache), this.Xh = !0, this.Yh.next(t);
    }, t;
}(), Bi = /** @class */ function() {
    function t(t, 
    ...
    t.prototype.gc = function(t) {
        return t.metadata.exists ? function(t, e, n) {
            var r = zn(t, e.name), i = qn(e.updateTime), o = new Ot({
                mapValue: {
                    fields: e.fields
                }
            });
 ...
 */ var Qi = function(t) {
    ...
    t.prototype.Pl = function() {
        return En.Oe(this.query, this._l, this.Ce, 0 /* Local */ === this.ul);
    }, t;
}(), Zi = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        /**
             ...
             */
        this.Nl = new Map, this.Ol = new jr, 
 ...
 */;
              ...
              case 2:
                return i = s.sent(), r.pl.xa(i.batchId), function(t, e, n) {
                    ...
                    r || (r = new rn(C)), r = r.Ht(e, n), t.Fl[t.currentUser.R()] = r;
    ...
    return y(this, void 0, void 0, (function() {
        ...
        return g(this, (function(o) {
            switch (o.label) {
              ...
              case 1:
                return o.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , kr(n.Sh, e) ];
              ...
              case 2:
                ...
                lo(n, r, /*error=*/ null), ho(n, r), n.pl.Oa(r, "acknowledged"), [ 4 /*yield*/ , wo(n, i) ];
        ...
        return g(this, (function(o) {
            switch (o.label) {
              ...
              case 2:
                ...
                // listen events.
                lo(r, e, n), ho(r, e), r.pl.Oa(e, "rejected", n), [ 4 /*yield*/ , wo(r, i) ];
...
function lo(t, e, n) {
    var r = D(t), i = r.Fl[r.currentUser.R()];
...
function yo(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Qi ? (t.Ol.sr(o.key, e), go(t, o)) : o instanceof Yi ? (E("SyncEngine", "Document no longer in limbo: " + o.key), 
        ...
        return y(this, void 0, void 0, (function() {
            ...
            return g(this, (function(c) {
                switch (c.label) {
                  ...
                  case 14:
                    return T("SyncEngine", "Loading bundle failed with " + (a = c.sent())), n.jl(a), 
                    [ 3 /*break*/ , 15 ];
...
var Io = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return y(this, void 0, void 0, (function() {
            return g(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.Kt = ii(t.gu.T), this.pl = this.Wl(t), this.persistence = this.Gl(t), 
    ...
    return t.prototype.initialize = function(t, e) {
        ...
        }, o = $r.jn() ? new $r : new Zr, new hi(e, n, r, i, o);
        ...
        return function(t) {
            return y(this, void 0, void 0, (function() {
                ...
                return g(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = D(t), E("RemoteStore", "RemoteStore shutting down."), e.Oh.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , pi(e) ];
 ...
 */ function Ho(t, e) {
    ...
    if (t instanceof x && (t = t._), ko("collection", "path", e), t instanceof Fo) return Ro(n = $.ct.apply($, m([ e ], r))), 
 ...
 */ function Bo(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = k.t()), ko("doc", "path", e), t instanceof Fo) return Vo(n = $.ct.apply($, m([ e ], r))), 
    new jo(t, 
...
/** A "context" object passed around while parsing user data. */ var $o = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.M_ = function(e) {
        ...
        return wu(t, this.settings.methodName, this.settings.j_ || !1, this.path, this.settings.W_);
    }, 
...
/** Parse update data from a list of field/value arguments. */ function fu(t, e, n, r, i, o) {
    ...
    for (var f = [], h = new kt, l = s.length - 1; l >= 0; --l) if (!bu(f, s[l])) {
        var p = s[l], d = a[l];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
...
function du(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof Y || t instanceof Wo || t instanceof U || t instanceof jo || t instanceof Oo);
}
 ...
 */ var _u = /** @class */ function() {
                                    ...
                                    return o = a.sent(), u = new Map, o.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = zn(t, e.found.name), r = qn(e.found.updateTime), i = new Ot({
                                                    mapValue: {
    ...
    t.prototype.Gt = function(t) {
        ...
        return !this.tf.has(t.toString()) && e ? Ue.updateTime(e) : Ue.jt();
    }, 
    /**
    ...
    e, n) {
        var r = this;
        this.credentials = t, this.fs = e, this.gu = n, this.user = G.UNAUTHENTICATED, this.clientId = k.t(), 
                                ...
                                return g(this, (function(i) {
                                    switch (i.label) {
                                      case 0:
                                        ...
                                        n.Oh.add(3 /* CredentialChange */), [ 4 /*yield*/ , pi(n) ];
                                      ...
                                      case 2:
                                        return i.sent(), n.Oh.delete(3 /* CredentialChange */), [ 4 /*yield*/ , li(n) ];
 ...
 */ var ys = /** @class */ function() {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        return this.fd.push(o.O_(r.S_, Ue.jt())), this;
        ...
        this.fd.push(o.O_(u.S_, Ue.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        this.Ed();
        var e = gs(t, this.zf);
        return this.fd = this.fd.concat(new Ze(e.S_, Ue.jt())), this;
    }, 
    /**
                ...
                return y(e, void 0, void 0, (function() {
                    ...
                    return g(this, (function(r) {
                        switch (r.label) {
                          ...
                          case 1:
                            return e = r.sent(), [ 4 /*yield*/ , ku(t) ];

                          case 2:
                            return n = r.sent(), [ 2 /*return*/ , (e.Vo(!0), function(t) {
                                var e = D(t);
                                return e.Oh.delete(0 /* UserDisabled */), li(e);
                            }(n)) ];
                        }
                    }));
                }));
                            ...
                            return n = r.sent(), [ 2 /*return*/ , (e.Vo(!1), function(t) {
                                return y(this, void 0, void 0, (function() {
                                    ...
                                    return g(this, (function(n) {
                                        switch (n.label) {
                                          case 0:
                                            return (e = D(t)).Oh.add(0 /* UserDisabled */), [ 4 /*yield*/ , pi(e) ];
 ...
 */;
        ...
        try {
            return new Ls(this, function(t, e) {
                if (t = Uo(t, Fo), ko("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new P(R.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
                return new zo(t, 
                /* converter= */ null, 
                /**
 ...
 */
    ...
    return w(e, t), e.prototype.Uf = function(t) {
        ...
        var e = this.Gf(t, this.firestore.I_);
        return As.Ad(e, this.firestore, /* converter= */ null);
    }, e;
}(Fu);
 ...
 */ var Ts = /** @class */ function(t) {
    ...
    return w(e, t), e.prototype.get = function(t) {
        ...
        return this._.get(n).then((function(t) {
            return new ks(e.zf, new us(e.zf._, e.Hf, t.S_, t.Jf, t.metadata, n.v_));
        }));
    ...
    return w(e, t), e.Rd = function(t, n, r) {
        ...
        get: function() {
            return new Ps(this.firestore, this._.parent);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(e.prototype, "path", {
        ...
        try {
            return new Ps(this.firestore, Ho(this._, t));
        } catch (t) {
        ...
        try {
            return function(t, e, n) {
                ...
                return ds(r, [ nu(eu(r), "setDoc", t.S_, i, null !== t.v_, n).O_(t.S_, Ue.jt()) ]);
            }(this._, t, e);
        } catch (t) {
        ...
        return ds(Uo((t = this._).firestore, xu), [ new Ze(t.S_, Ue.jt()) ]);
        var t;
        /**
 ...
 */    }, e.prototype.onSnapshot = function() {
        ...
        var r = Ds(e), i = Os(e, (function(e) {
            return new ks(t.firestore, new us(t.firestore._, t.Hf, e.S_, e.Jf, e.metadata, t._.v_));
        }));
        ...
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            ...
            return new ks(e.firestore, new us(e.firestore._, e.Hf, t.S_, t.Jf, t.metadata, e._.v_));
        }));
    }, e.prototype.withConverter = function(t) {
...
var ks = /** @class */ function(t) {
    ...
    return w(e, t), Object.defineProperty(e.prototype, "ref", {
        get: function() {
            return new As(this.zf, this._.ref);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(e.prototype, "id", {
     ...
     */
        function(t) {
            ...
            return new Rs(e.firestore, new as(e.firestore._, e.Hf, e._, t.ud));
        }));
    }, e.prototype.onSnapshot = function() {
        for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        var r = Ds(e), i = Os(e, (function(e) {
            return new Rs(t.firestore, new as(t.firestore._, t.Hf, t._, e.ud));
        }));
        return ps(this._, r, i);
    }, e.prototype.withConverter = function(t) {
        return new e(this.firestore, this._.withConverter(t));
    }, e;
}(x), Vs = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, n) || this).zf = e, r;
    }
    return w(e, t), Object.defineProperty(e.prototype, "type", {
        ...
        get: function() {
            return new Cs(this.zf, this._.doc);
        },
        enumerable: !1,
        configurable: !0
    ...
    return w(e, t), Object.defineProperty(e.prototype, "query", {
        get: function() {
            return new Ls(this.zf, this._.query);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(e.prototype, "metadata", {
        ...
        return this._.docChanges(t).map((function(t) {
            return new Vs(e.zf, t);
        }));
    }, e.prototype.forEach = function(t, e) {
        var n = this;
        this._.forEach((function(r) {
            t.call(e, new Cs(n.zf, r));
        }));
    }, e.prototype.isEqual = function(t) {
        return fs(this._, t._);
    }, e;
    ...
    return w(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        get: function() {
            var t = this._.parent;
            return t ? new As(this.firestore, t) : null;
        },
        enumerable: !1,
        configurable: !0
    }), e.prototype.doc = function(t) {
        try {
            return new As(this.firestore, void 0 === t ? Bo(this._) : Bo(this._, t));
        } catch (t) {
        ...
        return function(t, e) {
            ...
            return ds(n, [ nu(eu(t.firestore), "addDoc", r.S_, i, null !== t.v_, {}).O_(r.S_, Ue.exists(!1)) ]).then((function() {
                return r;
            }));
        }(this._, t).then((function(t) {
            return new As(e.firestore, t);
        }));
    }, e.prototype.isEqual = function(t) {
 ...
 */
    ...
    function t() {
        this.Pd = {}, this.yd = new ar, this.gd = {
            taskState: "Running",
            totalBytes: 0,
            totalDocuments: 0,
            bytesLoaded: 0,
...
function js(t, e) {
    return function(t, e) {
        ...
        return e ? new Ls(t, new zo(t._, null, e.query)) : null;
    }));
}

export { bs as B, As as G, Is as K, F as L, _s as U, Ns as W, Cs as X, ks as Y, xu as Z, Ls as a, Ps as b, Uu as c, Fs as d, Rs as e, js as f, xs as i, Ts as j, Wo as n, qs as r, Y as z };
//# sourceMappingURL=prebuilt-db9afa01-9ba551bb.js.map
