...
class Ut extends class {} {
    ...
    static Dt(t, e, n) {
        return "in" /* IN */ === e ? new jt(t, n) : new Wt(t, n);
    }
    matches(t) {
...
/** Filter that matches on key fields not present within an array. */ class Wt extends Ut {
    constructor(t, e) {
...
class Nn {
     ...
     */    wn(t) {
        for (const e of t.je) t.We instanceof Nt ? this.En(e, t.We) : t.We instanceof Ot && this.Tn(e, t.key, t.We);
...
function Xn(t, e, n) {
    const s = Wn(t, e.name), i = Un(e.updateTime), r = new St({
        mapValue: {
            fields: e.fields
        }
    });
...
function Zn(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = Wn(t, e.found.name), s = Un(e.found.updateTime), i = new St({
            mapValue: {
        ...
        const n = Wn(t, e.missing), s = Un(e.readTime);
        return new Ot(n, s);
    }(t, e) : V();
}
 ...
 */ (o);
        ...
        const i = Wn(t, s.document.name), r = Un(s.document.updateTime), o = new St({
            mapValue: {
        ...
        s.document;
        const i = Wn(t, s.document), r = s.readTime ? Un(s.readTime) : J.min(), o = new Ot(i, r), c = s.removedTargetIds || [];
        n = new Sn([], c, o.key, o);
...
function ns(t, e) {
    const n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Be.updateTime(Un(t.updateTime)) : void 0 !== t.exists ? Be.exists(t.exists) : Be.jt();
    }(e.currentDocument) : Be.jt(), s = e.updateTransforms ? e.updateTransforms.map((e => function(t, e) {
        let n = null;
 ...
 */
js.readTimeIndex = "readTimeIndex", js.readTimeIndexPath = "readTime", 
/**
 ...
 */
js.collectionReadTimeIndex = "collectionReadTimeIndex", js.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
// Visible for testing
const ti = [ ...[ ...[ ...[ ...[ Bs.store, qs.store, Us.store, js.store, Gs.store, $s.store, Hs.store, zs.store ], Ys.store ], Ws.store ], Js.store ], Xs.store, Zs.store ];
 ...
 */ class si {
    ...
    isEqual(t) {
        return this.batchId === t.batchId && C(this.mutations, t.mutations, ((t, e) => We(t, e))) && C(this.baseMutations, t.baseMutations, ((t, e) => We(t, e)));
    }
}
 ...
 */ class ki {
    ...
    Ki(t) {
        return this.Ui(t).next((t => J.j(new H(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds))));
    }
    ji(t) {
 ...
 */ class Wi {
    ...
    jr(t, e, n) {
        ...
        if (n.isEqual(J.min())) {
            ...
            /* open= */ !0), r.index = js.collectionReadTimeIndex;
        }
    ...
    getMetadata(t) {
        return zi(t).get(Ws.key).next((t => (p(!!t), t)));
    }
    Lr(t, e) {
        return zi(t).put(Ws.key, e);
    }
    /**
 ...
 */ (i)))), n < 4 && s >= 4 && (0 !== n && (
        ...
        n < 9 && s >= 9 && (r = r.next((() => {
            ...
            !function(t) {
                ...
                const e = t.objectStore(js.store);
                e.createIndex(js.readTimeIndex, js.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex(js.collectionReadTimeIndex, js.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }(e);
 ...
 */ (t);
    ...
    Jr(t) {
        let e = 0;
        return t.store(js.store).ls(((t, n) => {
            e += Si(n);
        })).next((() => {
            const n = new Ws(e);
     ...
     */    Yr(t) {
        const e = t.store(zs.store), n = t.store(js.store);
...
class tr {
    ...
    u) {
        ...
        this.ho = t => Promise.resolve(), !tr.jn()) throw new F(O.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
 ...
 */ class cr {
    ...
    /** Returns all local documents matching the specified query. */    jr(t, e, n, s) {
...
class ar {
    ...
    t, e, n, s) {
         ...
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.Ec = J.min(), this.Ho = t.Ko(n), this.Tc = t.Fr(), this.fo = t.Dr(), this.Ic = new rr(this.Tc, this.Ho, this.persistence.jo()), 
...
async function hr(t, e) {
    ...
    const r = await n.persistence.runTransaction("Handle user change", "readonly", (t => {
        ...
        // MutationQueue.
        i = new rr(n.Tc, s, n.persistence.jo()), s.bi(t)))).next((e => {
            const n = [], s = [];
 ...
 */ function Ir(t, e, n) {
    ...
    })).next((() => s.fc.jr(t, e, n ? i : J.min(), n ? r : Rn()))).next((t => ({
        documents: t,
        Pc: r
    })))));
}
 ...
 */ class br {
    ...
    xi(t, e) {
        p(0 === this.jc(e.batchId, "removed")), this.Ho.shift();
        let n = this.qc;
...
class Zr {
    constructor(t, e, n, s, i, r) {
         ...
         * close.
         */
        this.Wu = 0, this.Gu = null, this.stream = null, this.zu = new Xr(t, e);
    }
    /**
     ...
     */    ih(t) {
        return e => {
            this.eo.ys((() => this.Wu === t ? e() : (R("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve())));
        };
    }
}
...
function lc(t, e, n) {
    for (const s of n) if (s instanceof jo) t.Ol.sr(s.key, e), _c(t, s); else if (s instanceof Wo) {
 ...
 */ (t.Sh, s), n.Ul(o.progress);
            ...
            y("SyncEngine", "Loading bundle failed with " + t), n.jl(t);
        }
    }
    /**
 * @license
...
class Sc {
    ...
    async initialize(t) {
        this.Kt = Yr(t.gu.T), this.pl = this.Wl(t), this.persistence = this.Gl(t), await this.persistence.start(), 
 ...
 */ class Cc extends Dc {
    ...
    Wl(t) {
        const e = Hr();
        if (!Ur.jn(e)) throw new F(O.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
 ...
 */ class xc {
    ...
    t_(t) {
        ...
        r = jr.jn() ? new jr : new Kr, new io(e, n, s, i, r);
        var e, n, s, i, r;
...
class zc {
    /** @hideconstructor */
    constructor(t, e) {
        this.w_ = "(lite)", this.E_ = new Wc({}), this.T_ = !1, t instanceof q ? (this.I_ = t, 
...
/** A "context" object passed around while parsing user data. */ class aa {
    ...
    K_(t) {
        return va(t, this.settings.methodName, this.settings.j_ || !1, this.path, this.settings.W_);
    }
 ...
 */ class Da {
     ...
     */    Gt(t) {
        ...
        return !this.tf.has(t.toString()) && e ? Be.updateTime(e) : Be.jt();
    }
    /**
...
function iu(t) {
    ...
    return t.Mf.Tf((async () => {
        try {
            await async function(t) {
                if (!Ps.jn()) return Promise.resolve();
                const e = t + "main";
                await Ps.delete(e);
 ...
 */ class Mu {
    ...
    set(t, e, n) {
        ...
        return this.fd.push(r.O_(s.S_, Be.jt())), this;
    }
    update(t, e, n, ...s) {
        this.Ed();
     ...
     */    delete(t) {
        ...
        return this.fd = this.fd.concat(new tn(e.S_, Be.jt())), this;
    }
    /**
 ...
 */ class Wu extends M {
    ...
    get(t) {
        const e = ih(t);
        return this._.get(e).then((t => new Xu(this.zf, new bu(this.zf._, this.Hf, t.S_, t.Jf, t.metadata, e.v_))));
    }
    set(t, e, n) {
        const s = ih(t);
 ...
 */ class zu extends M {
    ...
    static Rd(t, e, n) {
        ...
        return new zu(e, new Hc(e._, n, new et(t)));
    }
    static Ad(t, e, n) {
    ...
    set(t, e) {
        ...
        try {
            return function(t, e, n) {
                ...
                return Fu(s, [ la(ha(s), "setDoc", t.S_, i, null !== t.v_, n).O_(t.S_, Be.jt()) ]);
            }(this._, t, e);
        } catch (t) {
    ...
    delete() {
        return Fu(Kc((t = this._).firestore, tu), [ new tn(t.S_, Be.jt()) ]);
        var t;
        /**
 ...
 */ (this._) : function(t) {
            t = Kc(t, Hc);
            const e = Kc(t.firestore, tu);
            return ja(eu(e), t.S_).then((n => ku(e, t, n)));
    ...
    limit(t) {
        try {
            return new th(this.firestore, fu(this._, function(t) {
                return jc("limit", t), new Eu("limit", t, "F" /* First */);
            }
            /**
 ...
 */ (t)));
    ...
    limitToLast(t) {
        try {
            return new th(this.firestore, fu(this._, function(t) {
                return jc("limitToLast", t), new Eu("limitToLast", t, "L" /* Last */);
            }(t)));
        } catch (t) {
 ...
 */
        function(t) {
            t = Kc(t, Jc);
            const e = Kc(t.firestore, tu), n = eu(e), s = new xu(e);
            return Wa(n, t.C_).then((n => new Su(e, s, t, n)));
        }
        /**
 ...
 */ class ch {
    constructor() {
        this.Pd = {}, this.yd = new ms, this.gd = {
            taskState: "Running",
            totalBytes: 0,
            totalDocuments: 0,
            bytesLoaded: 0,
...
export { $, Gu as G, H, Qu as Q, Uu as U, Wu as W, Xu as X, Zu as Z, sh as a, Za as b, tu as c, ah as d, ju as j, nh as n, oh as o, rh as r, sa as s, th as t, uh as u, zu as z };
//# sourceMappingURL=prebuilt.rn-2a90e831.js.map
